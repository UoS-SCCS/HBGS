...
void KeccakP1600times8_AddByte(void *states, unsigned int instanceIndex,
...
void KeccakP1600times8_OverwriteBytes(void *states, unsigned int instanceIndex,
  const unsigned char *data, unsigned int offset, unsigned int length);
...
void KeccakP1600times8_ExtractBytes(const void *states,
  ...
  unsigned int length);
void KeccakP1600times8_ExtractLanesAll(const void *states, unsigned char *data,
  unsigned int laneCount, unsigned int laneOffset);
