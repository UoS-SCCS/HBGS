...
#define KCP_DeclareSpongePRG_Functions(prefix)                          \
    int prefix##_SpongePRG_Initialize(                                  \
      prefix##_SpongePRG_Instance *instance, unsigned int capacity);    \
    int prefix##_SpongePRG_Feed(prefix##_SpongePRG_Instance *instance,  \
      const unsigned char *input, unsigned int inputByteLen);           \
    int prefix##_SpongePRG_Fetch(prefix##_SpongePRG_Instance *Instance, \
      unsigned char *out, unsigned int outByteLen);                     \
