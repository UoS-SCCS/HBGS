...
typedef struct msgs_t
{
    ...
    size_t pos;
    int unopened;// Index of the unopened party, or -1 if all parties opened
                 // (when signing)
} msgs_t;
...
void allocateCommitments2(
  commitments_t *commitments, paramset_t *params, size_t nCommitments);
 ...
 ******************************************************************************/
size_t getTapeSizeBytes_test5(const paramset_t *params);

void allocateRandomTape_test5(randomTape_t *tape, paramset_t *params);

void allocateProof2_test5(proof2_t *proof, paramset_t *params);

msgs_t *allocateMsgs_test5(paramset_t *params);
